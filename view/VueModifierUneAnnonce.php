<div class="row">
    ...
    <div class="col-xxs-12">
        <form class="form-horizontal" method="post" action="index.php?action=TraiterModifierUneAnnonce">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="pays" name="pays_id" onchange="changerSubdivisions1()">
                        <option value="-1">--- Sélectionnez le pays ---</option>
            ...
            <div class="form-group" id="ligne_subdivisions1">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="subdivision1" name="subdivision1_id" onchange="changerSubdivisions2()">
                        <option value="-1">--- Sélectionnez la région ---</option>
            ...
            <div class="form-group" id="ligne_subdivisions2">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="subdivision2" name="subdivision2_id">
                        <option value="-1">--- Sélectionnez le département ---</option>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <input type="hidden" name="id" value="<?= $donnees['annonce']->getId(); ?>">
